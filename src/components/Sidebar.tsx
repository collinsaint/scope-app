        ...
        {onSignOut && (
          <div className={`flex-shrink-0 px-2.5 pb-1 transition-opacity duration-300 ${collapsed ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
            <div className="flex items-center gap-2 px-3 py-2">
              ...
              <span className="text-[11px] text-slate-500 truncate flex-1 min-w-0">{userEmail}</span>
              <button onClick={onSignOut} title="Sign out" className="flex-shrink-0 text-slate-600 hover:text-red-400 transition-colors">

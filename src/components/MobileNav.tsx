            ...
            <div className="p-3 flex flex-col gap-1">
              ...
              {onSignOut && (
                <button
                  ...
                  className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors text-left hover:bg-white/10"
                  style={{ color: 'rgba(239,100,100,0.9)' }}
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
